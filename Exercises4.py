...
def my_stats(ilis):
    import statistics
    print("Mean: ", statistics.mean(ilis))
    print("Median: ", statistics.median(ilis))
    print("Mode: ", statistics.mode(ilis))    
#    try:
#        print("Mode: ", statistics.mode(slis))
#    except statistics.StatisticsError as e:
#        print("Mode error: ", e)
    print("Standard Deviation: ", statistics.stdev(ilis))
    print("Variance: ", statistics.variance(ilis))
